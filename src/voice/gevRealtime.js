    ...
    const contextEvent = {
      ...
      item: {
        ...
        content: [
          {
            type: 'input_text',
            text: "Current PROJECT CHARLIE TUNA viewport screenshot. Read any clearly visible street, building, and place labels in the image and combine them with the structured nearbyPlaces, streetLabels, and scene context. Do not invent labels that are not legible.",
          },
          {
            type: 'input_image',
            image_url: imageUrl,
